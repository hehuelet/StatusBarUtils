...
/**
 * 状态栏背景色修改
 * Created by HeHu on 2017/7/26/0026.
 */
...
public class StatusBarUtils {
    ...
    public static boolean isFullScreen(Activity activity) {
        return (activity.getWindow().getAttributes().flags & WindowManager.LayoutParams
    ...
    public static void setColor(Activity activity, @ColorInt int color, @IntRange(from = 0, to =
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            StatusBarFontUtils.setStatusBarMode(activity, StatusBarFontUtils.isLightColor
                    (activity, color));
    ...
    public static void setColorDiff(Activity activity, @ColorInt int color) {
        ...
        setRootView(activity);
        StatusBarFontUtils.setStatusBarMode(activity, StatusBarFontUtils.isLightColor(activity,
                color));
    }
